// COMPATIBILITY COPY — cv32e40x upstream renamed if_xif -> cv32e40x_if_xif
// (vendor bump to d952cd63). The x-heep XIF plumbing (cve2/cv32e40px XIF
// wrappers, fpu_ss, quadrilatero) still uses the legacy if_xif name; this
// copy of the pre-rename interface keeps those consumers compiling. Kept
// OUTSIDE the vendored subtree so re-vendoring cannot clobber it.
/*
