...
module FPUFMAPipe_l3_f32(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  wire [32:0] _fma_io_out;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in2 <= io_in_bits_swap23 ? 65'h80000000 : io_in_bits_in2;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :714:8, :715:{23,32}]
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : {32'h0, (io_in_bits_in1[32:0] ^ io_in_bits_in2[32:0]) & 33'h100000000};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14, :708:15, :711:{32,50}, :714:8, :716:{21,37,46}]
    end
  end // always @(posedge)
  ...
  MulAddRecFNPipe_l2_e8_s24 fma (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
    .clock             (clock),
    .reset             (reset),
    ...
    .io_a              (in_in1[32:0]),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :724:12]
    .io_b              (in_in2[32:0]),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :725:12]
    .io_c              (in_in3[32:0]),	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :726:12]
  ...
  assign io_out_bits_data = {32'h0, ({33{_fma_io_out[31:29] != 3'h7}} | 33'h1EF7FFFFF) & _fma_io_out};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :414:10, :697:7, :711:50, :719:19, :729:12]
endmodule
