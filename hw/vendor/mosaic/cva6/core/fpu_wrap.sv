...
#(
  ...
  if (CVA6Cfg.FpPresent) begin : fpu_gen
    ...
    fpnew_top #(
        ...
        .busy_o        (  /* unused */)
        // MOSAIC divergence: .early_valid_o exists only in the cvfpu fork;
        // the in-tree standard fpnew has no such port. Tied below (the FPU
        // generate is dead anyway in the MOSAIC config: RVF/RVD = 0).
    );
    assign fpu_early_valid_o = fpu_out_valid;
