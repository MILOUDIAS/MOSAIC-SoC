...
//
// Wraps the RocketTile extracted from chipyard 1.14.0 (CONFIG=
...
module rocket_sci #(
    ...
    // TileLink port geometry of the extracted RocketTile (from the generated
    // port list: a32 d64 s2 k3 z4).
    localparam int unsigned TL_AW    = 32;
    localparam int unsigned TL_SZW   = 4;
    localparam int unsigned TL_SRCW  = 2;
    ...
    // ── the extracted tile (port names from the generated RocketTile.sv) ─
    RocketTile #(
